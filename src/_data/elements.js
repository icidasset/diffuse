...
export default {
  ...
  orchestrators: [
    ...
    { url: "components/orchestrator/offline/element.js", title: "Offline", desc: "Registers a service worker that makes the page available offline. Resources (except audio & video) are cached as they load and served from cache when offline." },
