...
export default {
  ...
  configurators: [
    {
      url: "components/configurator/artwork/element.js",
      title: "Artwork",
      desc:
    ...
    {
      url: "components/configurator/metadata/element.js",
      title: "Metadata",
      desc:
  ...
  engines: [
    {
      url: "components/engine/audio/element.js",
      title: "Audio",
      desc: "Plays audio through audio elements.",
    },
    {
      url: "components/engine/queue/element.js",
      title: "Queue",
      desc: "A queue for tracks.",
    },
    {
      url: "components/engine/repeat-shuffle/element.js",
    ...
    {
      url: "components/engine/scope/element.js",
      title: "Scope",
      desc: "Signals that could influence the scope of a set of tracks.",
    },
  ],

  input: [
    {
      url: "components/input/dropbox/element.js",
      title: "Dropbox",
      desc: "Dropbox, using the Dropbox v2 HTTP API.",
    },
    {
      url: "components/input/ephemeral-cache/element.js",
      title: "Ephemeral Cache",
      desc:
        "Ephemeral blobs stored in indexedDB, resolving creates temporary Blob URLs. Not responsible for storing blobs.",
    },
    {
      url: "components/input/https/element.js",
      title: "HTTPS",
    ...
    {
      url: "components/input/local/element.js",
      title: "Local",
      desc:
        "Audio files or directories from your local device, using the browser's File System Access API.",
    },
    {
      url: "components/input/opensubsonic/element.js",
      title: "Opensubsonic",
      desc: "(Open)subsonic audio servers.",
    },
    {
      url: "components/input/s3/element.js",
      title: "S3",
      desc:
        "AWS S3 and services that provide the same surface API such as Cloudflare R2.",
    },
    {
      url: "components/input/webdav/element.js",
      title: "WebDAV",
      desc:
  ...
  metadata: [
    {
      url: "components/metadata/audio-file/element.js",
      title: "Audio File",
      desc:
  ...
  orchestrators: [
    {
      url: "components/orchestrator/artwork/element.js",
      title: "Artwork",
      desc:
    ...
    {
      url: "components/orchestrator/auto-queue/element.js",
    ...
    {
      url: "components/orchestrator/controller/element.js",
      title: "Controller",
      desc:
    ...
    {
      url: "components/orchestrator/cover-groups/element.js",
      title: "Cover Groups",
      desc: "Groups tracks by cover art to form collections.",
    },
    {
      url: "components/orchestrator/favourites/element.js",
      title: "Favourites",
      desc:
        "Mark tracks as favourites. Automatically creates an unordered 'Favourites' playlist.",
    },
    {
      url: "components/orchestrator/media-session/element.js",
      title: "Media Session",
      desc:
        "Keeps the browser/os media session in sync with queue and audio state. Adds handlers for previous, next, seek to, etc.",
    },
    {
      url: "components/orchestrator/output/element.js",
      title: "Output",
      desc:
        "A default output configuration. Contains all the outputs provided here along with the relevant transformers.",
    },
    {
      url: "components/orchestrator/path-collections/element.js",
      title: "Path Collections",
      desc:
    ...
    {
      url: "components/orchestrator/process-tracks/element.js",
      title: "Process Inputs Into Tracks",
      desc:
    ...
    {
      url: "components/orchestrator/queue-audio/element.js",
      title: "Queue ⭤ Audio",
      desc: "Connects the given queue engine to the given audio engine.",
    },
    {
      url: "components/orchestrator/scoped-tracks/element.js",
      title: "Scoped Tracks",
      desc:
    ...
    {
      url: "components/orchestrator/scrobble-audio/element.js",
      title: "Scrobble ⭤ Audio",
      desc:
    ...
    {
      url: "components/orchestrator/sources/element.js",
      title: "Sources",
      desc:
  ...
  output: [
    {
      url: "components/output/polymorphic/indexed-db/element.js",
      title: "Polymorphic / IndexedDB",
      desc:
        "Stores output into the local indexedDB. Supports any type of data that indexedDB supports.",
    },
    {
      url: "components/output/bytes/s3/element.js",
      title: "Bytes / S3",
      desc:
  ...
  supplements: [
    {
      url: "components/supplement/last.fm/element.js",
      title: "Last.fm Scrobbler",
      desc: "Scrobbles track plays to Last.fm.",
    },
    {
  ...
  transformers: [
    {
      url: "components/transformer/output/bytes/automerge/element.js",
      title: "Output / Bytes / Automerge",
      desc: "Translate data to and from an Automerge CRDT.",
      todo: true,
    },
    {
      url: "components/transformer/output/bytes/dasl-sync/element.js",
      title: "Output / Bytes / DASL Sync",
      desc:
    ...
    {
      url: "components/transformer/output/bytes/json/element.js",
      title: "Output / Bytes / JSON",
      desc: "Raw data schema output to and from JSON Uint8Array.",
    },
    {
    ...
    },
    {
      ...
      title: "Output / Refiner / Default",
      desc:
        "Removes output state that is not meant to be saved to storage, such as ephemeral tracks. Ideally part of every theme.",
    },
    {
      url: "components/transformer/output/refiner/initial-contents/element.js",
      title: "Output / Refiner / Initial Contents",
      desc: "Sets the initial contents for an output on first load.",
    },
    {
      url:
        "components/transformer/output/refiner/passkey-encryption/element.js",
      title: "Output / Refiner / Track URI Passkey",
      desc:
    ...
    {
      url: "components/transformer/output/string/json/element.js",
      title: "Output / String / JSON",
      desc: "Raw data schema output to and from JSON UTF8 string.",
    },
  ],
  ...
  definitions: [
    ...
    {
      url: "definitions/output/trackBundle.json",
      title: "Output / Track Bundle",
      desc: "A bundle of tracks.",
    },
  ],
};
