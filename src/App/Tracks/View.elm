...
entry model =
    column
        ...
        -- Hide the tracks view when a different page is shown.
        -- This is to avoid a visual glitch.
        , inlineStyle
...
msgOffline : Node
msgOffline =
    el (Tracks Placeholder) [] (text "No sources available")
...
noTracksFound : ( List Source, IsProcessing ) -> Int -> Bool -> Node
noTracksFound ( sources, isProcessing ) amountOfFavourites isOnline =
    within
        [ logoBackdrop
        , el
            Zed
